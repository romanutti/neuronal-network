function [J grad] = nnnnCostFunction(nn_params, ...
                                   input_layer_size, ...
                                   hidden_layer_size, ...
                                   num_labels, ...
                                   X, y, lambda)
%NNNNCOSTFUNCTION Implements the neural network cost function for a four layer
%neural network which performs classification
%   [J grad] = NNNNCOSTFUNCTON(nn_params, hidden_layer_size, num_labels, ...
...
z2c = a2b * Theta3';
a2c = [ones(size(z2c, 1), 1), sigmoid(z2c)];
...
for t = 1:m
    ...
    % Step 3b
    delta2c = (Theta4(:, 2:end)'... // remove bias
              * delta3) .* sigmoidGradient(z2c);
    
    % Step 3b
    delta2b = (Theta3(:, 2:end)'... // remove bias
              * delta2c) .* sigmoidGradient(z2b);
    ...
    % Step 4
    delta2ccum = delta2ccum +(delta3 * a2c');
    delta2bcum = delta2bcum +(delta2c * a2b');
